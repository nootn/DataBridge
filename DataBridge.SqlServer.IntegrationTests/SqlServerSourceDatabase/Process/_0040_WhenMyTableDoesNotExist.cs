...
{
    public class _0040_WhenMyTableDoesNotExist : SpecsFor<SqlServer.SqlServerSourceDatabase>
    {
        ...
        public void then_the_correct_exception_is_thrown()
        {
            _caughtException.Message.ShouldStartWith(
                SqlServer.SqlServerSourceDatabase.ExceptionMessagePrefixTableNotExists);
        }
    }
}